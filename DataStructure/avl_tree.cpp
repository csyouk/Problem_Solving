...
////  DataStructure
////
////  Created by youkchangsu on 2018. 5. 10..
...
//NodeAVL *AVL::balance(NodeAVL *temp)
//{
...
//
//// 트리에 원소를 삽입하는 함수입니다.
//NodeAVL * AVL::insert(NodeAVL *root, int value)
//{
//  // 현재 트리가 비었을 때
//  if(root == NULL)
//  {
...
//}
//
//void AVL::display(NodeAVL * ptr, int level)
//{
//  int i;
...
//  inorder(tree->right);
//}
//void AVL::preorder(NodeAVL *tree)
//{
//  if(tree == NULL)
//    return;
//  cout << tree->data << "  ";
...
//  inorder(tree->right);
//}
//void AVL::postorder(NodeAVL *tree)
//{
//  if(tree == NULL)
//    return;
//  inorder(tree->left);
